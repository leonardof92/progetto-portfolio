...
urlpatterns = [
    ...
    #url(r'^skill_item/new/$', views.skill_item_new, name='skill_item_new'), 
    url(r'^skill/(?P<pk>[0-9]+)/item/new/$', views.skill_item_new, name='skill_item_new'), 
    ...
    #url(r'^skill_item/(?P<pk>[0-9]+)/edit/$',views.skill_item_edit, name='skill_item_edit'),
    url(r'^skill/(?P<pk>[0-9]+)/item/(?P<pk_item>\d+)/edit/$',views.skill_item_edit, name='skill_item_edit'),
    ...
    #url(r'^skill_item/(?P<pk>\d+)/remove/$', views.skill_item_remove, name='skill_item_remove'),
    url(r'^skill/(?P<pk>[0-9]+)/item/(?P<pk_item>\d+)/remove/$', views.skill_item_remove, name='skill_item_remove'),
]
